<?php 
	...
	function custom_dashboard_help() { ?>
	    ...
	    <p>Hệ thống được phát triển bởi <a href="http://hokien07.net/"><strong>hokien07</strong></a></p>
	    <p>Mọi yêu cầu, hỗ trợ quý khách hàng có thể liên hệ <strong>PHP Developers</strong></p>
	    <p><strong>Điện thoại</strong>: 0868.098.591</p> 
	    <p><strong>Email</strong>: hokien07@gmail.com - <strong>Website</strong>: <a href="http://hokien07.net/"><strong>Hpkien07.net</strong></a></p> 
	    <p><strong>Cảm ơn quý khách đã tin tưởng và sử dụng sản phẩm của Kien.</strong></p>
	<?php }
