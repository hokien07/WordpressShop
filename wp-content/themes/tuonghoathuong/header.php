	...
	<div id="wrapper">
		<div id="header">
			<div class="header-top">
				<div class="container">
					<p class="pull-left">Chào mừng bạn đến với trang Tượng Hòa Thượng</p>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-3 col-sm-12 col-xs-12 logo">
							<a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo("template_directory"); ?>/images/logo-tuong.jpg" alt="<?php bloginfo('name'); ?>" style="border-radius: 20px;"/></a>
						</div>
									...
									<div class="row">
										<div class="col-xs-12 col-sm-3 col-md-3 no-padding">
											<select name="product_cat" class="form-control">
												<option class="boldoption" value="">Tất cả</option>
												<?php $args = array( 
												    'hide_empty' => 0,
										...
										<div class="col-xs-12 col-sm-9 col-md-9 no-padding">
											<input type="text" name="s" class="form-control" placeholder="Hòa Thượng Thích trí Tịnh">
						...
						<div class="col-md-3 col-sm-6 col-xs-12 giohang text-right">
							<p><strong style="color: red; ">HOTLINE: 096.251.7055 - 0932.365.773</strong></p>
						</div>	
					</div>
				</div>
